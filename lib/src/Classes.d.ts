...
export declare class TranscodingUser {
    ...
    constructor(uid: number, x: number, y: number, { width, height, zOrder, alpha, audioChannel }: {
        width?: number;
        height?: number;
        zOrder?: number;
        alpha?: number;
...
export declare class LiveTranscoding {
    ...
    constructor(transcodingUsers: TranscodingUser[], { width, height, videoBitrate, videoFramerate, lowLatency, videoGop, watermark, backgroundImage, audioSampleRate, audioBitrate, audioChannels, audioCodecProfile, videoCodecProfile, backgroundColor, userConfigExtraInfo }: {
        width?: number;
        height?: number;
        videoBitrate?: number;
        videoFramerate?: VideoFrameRate;
...
export declare class ChannelMediaInfo {
     ...
     */
    uid: number;
    constructor(uid: number, { channelName, token }: {
        channelName?: string;
        token?: string;
    });
}
